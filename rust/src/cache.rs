...
use jni_sys::{self, jarray, jboolean, jbooleanArray, jbyte, jbyteArray, jchar, jcharArray, jclass, jdouble, jdoubleArray, jfloat, jfloatArray, jint, jintArray, jlong, jlongArray, jmethodID, JNIEnv, jobject, jobjectArray, jshort, jshortArray, jsize, jstring};
use libc::c_char;
...
macro_rules! primitive_array_declarations {
    (
...
primitive_array_declarations!(JniGetByteArrayElements, JniReleaseByteArrayElements, JNI_GET_BYTE_ARRAY_ELEMENTS, JNI_RELEASE_BYTE_ARRAY_ELEMENTS, set_jni_get_byte_array_elements, get_jni_get_byte_array_elements, set_jni_release_byte_array_elements, get_jni_release_byte_array_elements, jbyteArray, jbyte);
primitive_array_declarations!(JniGetShortArrayElements, JniReleaseShortArrayElements, JNI_GET_SHORT_ARRAY_ELEMENTS, JNI_RELEASE_SHORT_ARRAY_ELEMENTS, set_jni_get_short_array_elements, get_jni_get_short_array_elements, set_jni_release_short_array_elements, get_jni_release_short_array_elements, jshortArray, jshort);
primitive_array_declarations!(JniGetIntArrayElements, JniReleaseIntArrayElements, JNI_GET_INT_ARRAY_ELEMENTS, JNI_RELEASE_INT_ARRAY_ELEMENTS, set_jni_get_int_array_elements, get_jni_get_int_array_elements, set_jni_release_int_array_elements, get_jni_release_int_array_elements, jintArray, jint);
primitive_array_declarations!(JniGetLongArrayElements, JniReleaseLongArrayElements, JNI_GET_LONG_ARRAY_ELEMENTS, JNI_RELEASE_LONG_ARRAY_ELEMENTS, set_jni_get_long_array_elements, get_jni_get_long_array_elements, set_jni_release_long_array_elements, get_jni_release_long_array_elements, jlongArray, jlong);
primitive_array_declarations!(JniGetFloatArrayElements, JniReleaseFloatArrayElements, JNI_GET_FLOAT_ARRAY_ELEMENTS, JNI_RELEASE_FLOAT_ARRAY_ELEMENTS, set_jni_get_float_array_elements, get_jni_get_float_array_elements, set_jni_release_float_array_elements, get_jni_release_float_array_elements, jfloatArray, jfloat);
primitive_array_declarations!(JniGetDoubleArrayElements, JniReleaseDoubleArrayElements, JNI_GET_DOUBLE_ARRAY_ELEMENTS, JNI_RELEASE_DOUBLE_ARRAY_ELEMENTS, set_jni_get_double_array_elements, get_jni_get_double_array_elements, set_jni_release_double_array_elements, get_jni_release_double_array_elements, jdoubleArray, jdouble);
primitive_array_declarations!(JniGetCharArrayElements, JniReleaseCharArrayElements, JNI_GET_CHAR_ARRAY_ELEMENTS, JNI_RELEASE_CHAR_ARRAY_ELEMENTS, set_jni_get_char_array_elements, get_jni_get_char_array_elements, set_jni_release_char_array_elements, get_jni_release_char_array_elements, jcharArray, jchar);
primitive_array_declarations!(JniGetBooleanArrayElements, JniReleaseBooleanArrayElements, JNI_GET_BOOLEAN_ARRAY_ELEMENTS, JNI_RELEASE_BOOLEAN_ARRAY_ELEMENTS, set_jni_get_boolean_array_elements, get_jni_get_boolean_array_elements, set_jni_release_boolean_array_elements, get_jni_release_boolean_array_elements, jbooleanArray, jboolean);
